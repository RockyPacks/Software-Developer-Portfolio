    ...
    <div className="bg-white dark:bg-primary text-gray-900 dark:text-text-primary font-sans min-h-screen flex flex-col transition-colors duration-300">
      ...
      <div className="fixed bottom-8 right-8 z-40">
          <button
              ...
              className="bg-blue-600 text-white dark:bg-accent dark:text-primary rounded-full p-4 shadow-lg hover:bg-blue-700 dark:hover:bg-white transition-colors duration-300"
